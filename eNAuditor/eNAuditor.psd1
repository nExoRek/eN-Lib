#
# Module manifest for module 'eNUserReporting'
#
...
ModuleVersion = '0.920.0'

# Supported PSEditions
# CompatiblePSEditions = @()

# ID used to uniquely identify this module
GUID = '03b12da6-785f-463b-95bc-8b944c4691d7'
...
FunctionsToExport = @('get-ADPrivilegedUsers','get-MFAReport','get-EntraIDPrivilegedUsers','get-ReportADObjects','get-ReportEntraUsers','get-ReportMailboxes','join-ReportHybridUsersInfo','disable-perUserMFA')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("Identity", "Audit", "Reporting", "M365")

        # A URL to the license for this module.
        LicenseUri = 'https://opensource.org/licenses/MIT'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/nExoRek/eN-Lib/tree/master/userReporting'
...
DefaultCommandPrefix = 'eNAuditor'
